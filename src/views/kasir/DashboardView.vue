<template>
  <div class='min-h-screen bg-gray-50 flex flex-col relative pb-20'>
    ...
    <div class="fixed bottom-0 left-0 right-0 bg-white border-t flex justify-around items-center px-2 py-1 pb-safe z-[1000] shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
      <router-link to="/kasir" class="flex flex-col items-center p-2 text-gray-400 w-16" active-class="!text-blue-600 font-bold">
        <HomeIcon class="w-5 h-5 mb-0.5" />
        <span class="text-[10px]">Dashboard</span>
      </router-link>
      
      <router-link to="/kasir/pos" class="flex flex-col items-center p-2 text-gray-400 hover:text-blue-600 transition w-16" active-class="!text-blue-600 font-bold">
...
import { SettingsIcon, ShoppingCartIcon, HomeIcon, XIcon, BluetoothIcon, SearchIcon } from 'lucide-vue-next'
